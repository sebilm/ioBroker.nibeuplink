...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Sebastian Haesselbarth';
    var email  = 'seb@sebmail.de';
    ...
    if (!newname) {
        console.log('Please write the new nibeuplink name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/nibeuplink.png')) {
        fs.renameSync(__dirname + '/admin/nibeuplink.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/nibeuplink.html')) {
        fs.renameSync(__dirname + '/widgets/nibeuplink.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/nibeuplink/js/nibeuplink.js')) {
        fs.renameSync(__dirname + '/widgets/nibeuplink/js/nibeuplink.js', __dirname + '/widgets/nibeuplink/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/nibeuplink')) {
        fs.renameSync(__dirname + '/widgets/nibeuplink',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /nibeuplink/g,
        ...
        {
            match: /Nibeuplink/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Nibeuplink'
        },
        {
            match: /Sebastian Haesselbarth/g,
            replacement: author
        },
        {
            match: /seb@sebmail.de/g,
            replacement: email
        }
    ];
    var files = [
